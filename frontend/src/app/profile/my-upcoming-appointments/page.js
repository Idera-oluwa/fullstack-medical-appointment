...
const page = () => {
  return (
    <div className='bg-gray-100 mt-[4.5rem] mb-[3cm]'>
     ...
     <div className='w-[1.9cm] h-[1.9cm] '><img src='/Images/available-doctor-1.jpg' 
     alt=''
     className='rounded-[10px] object-cover h-[100%] w-full'
     /></div>
     <div className='flex flex-col'>
     <p className='font-semibold text-[0.9rem] text-dark'>Dr. Mahububa Islam</p>
     <p className='text-secondary text-[0.75rem] mt-[0.3rem]'>Gynecology</p>
     <div className='flex flex-row mt-[0.8rem] items-center gap-[0.2cm]'>
     <FaRegCalendarAlt className='text-primary text-[0.7rem]'/>
      <p className='text-secondary text-[0.7rem]'>20 Nov 2023</p></div>
     </div>
     </div>
     <div className='flex flex-col ml-auto gap-[0.9rem]'>
      <div className='bg-[#c0eef789] flex items-center justify-center w-[1cm] h-[1cm] rounded-full ml-auto'><FaPhoneAlt className='text-light-primary'/></div>
      <div className='px-[0.5rem] py-[0.115rem] rounded-full bg-success-bg-subtle'><p className='text-[0.55rem] text-success'>RUNNING</p></div>
      </div>
     </div>
    ...
    <p className='text-[0.75rem] font-semibold text-primary'>7 Years</p>
      ...
      <p className='text-[0.75rem] text-secondary mt-[0.5rem]'>Visit Time</p>
       </div>
       <div className='flex flex-col'>
       <p className='text-[0.75rem] text-secondary'>: Thursday, Nov 13, 2021</p>
      <p className='text-[0.75rem] text-secondary mt-[0.5rem]'>: Afternoon - 2:00 - 2:30 PM</p>
       </div>
      </div>
      </div>
      <div className='bg-white p-[1rem] outline outline-1 outline-gray-200'>
      ...
      <p className='text-[0.75rem] text-secondary mt-[0.5rem]'>: 2348086357254</p>
       </div>
      </div>
      </div>
      <div className='bg-white p-[1rem] outline outline-1 outline-gray-200'>
      <p className='font-semibold text-[0.83rem] text-dark'>Fee Information</p>
      <div className='flex flex-row gap-[1rem] mt-[0.8rem]'>
       <div className='flex flex-col'>
       <p className='text-[0.75rem] text-secondary'>Short Time</p>
      <p className='text-[0.75rem] text-secondary mt-[0.5rem]'>Long Time</p>
       </div>
       <div className='flex flex-col'>
       <p className='text-[0.75rem] text-secondary'>: $99</p>
      <p className='text-[0.75rem] text-secondary mt-[0.5rem]'>: $199</p>
       </div>
      </div>
      </div>
      <div className='bg-light-primary w-full flex items-center justify-center py-[1rem] rounded-[10px] mt-[1rem] cursor-pointer'>
      <p className='text-white font-semibold text-[0.9rem]'>Call Now &#40;Start at 2:00 PM&#41;</p>
      </div>
      </div>
      <Footer/>
    </div>
