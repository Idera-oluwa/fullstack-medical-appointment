...
const Tab3 = () => {
  ...
  return (
    <div className="bg-gray-100 py-[0.5cm] pb-[8rem] mt-[-0.5cm]   w-full">
      <p className="px-[0.5cm] text-[0.93rem] font-semibold text-dark">
        Review &#40;2350&#41;
      </p>
      <div className=" mt-[0.5cm] flex flex-col gap-[0.1rem]">
        <div className="px-[0.5cm] bg-white py-[0.25cm] flex flex-row items-center">
          ...
          <div className="flex flex-row ml-auto items-center gap-[0.5rem]">
            ...
            <div className="text-dark font-bold text-[0.5rem] bg-warning w-[1.5rem] h-[0.8rem] rounded-full flex justify-center items-center">
              <p>4.9</p>
            </div>
          </div>
        </div>
      ...
      <p className="text-primary text-center text-[0.8rem] underline mt-[0.5cm] font-semibold cursor-pointer">
        Tap here to see all reviews
      </p>
    </div>
  );
};
