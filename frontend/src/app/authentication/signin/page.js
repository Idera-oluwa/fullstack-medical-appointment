...
const signin = () => {
  return (
    ...
    <p className='text-[25px] text-dark font-semibold mt-[2.3rem]'>Let's Sign in</p>
    <p className='text-secondary text-[13px] mt-[1rem]'>Welcome back, you've been missed!</p>
    <form className='mt-4 flex flex-col gap-4'>
      ...
      <button className='text-white bg-light-primary h-[3.5rem] w-full rounded-[15px] font-semibold mt-6'>Login</button>
       </form>
    </div>
  )
}
